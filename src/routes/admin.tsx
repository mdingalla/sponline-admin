...
import { AdminPagePath, GroupsPagePath, GroupsPath, pagePath, SignatoryAdminPagePath, SupplierMasterSyncPath, SupplierUpdateAdminPagePath, TRAdmin, TRImportPagePath } from "../constants/config";
